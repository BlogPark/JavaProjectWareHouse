...
<!-- bootstrap & fontawesome -->
		...
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="${pageContext.request.contextPath }/css/ace-part2.min.css" class="ace-main-stylesheet" />
		<![endif]-->
				...
				<ul class="nav ace-nav">
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar">
									<li><a href="#" class="clearfix"> <img
											src="${pageContext.request.contextPath }/images/avatars/avatar.png" class="msg-photo"
									...
									<li><a href="#" class="clearfix"> <img
											src="${pageContext.request.contextPath }/images/avatars/avatar3.png" class="msg-photo"
									...
									<li><a href="#" class="clearfix"> <img
											src="${pageContext.request.contextPath }/images/avatars/avatar4.png" class="msg-photo"
									...
									<li><a href="#" class="clearfix"> <img
											src="${pageContext.request.contextPath }/images/avatars/avatar2.png" class="msg-photo"
									...
									<li><a href="#" class="clearfix"> <img
											src="${pageContext.request.contextPath }/images/avatars/avatar5.png" class="msg-photo"
					...
					<li class="light-blue dropdown-modal"><a
						data-toggle="dropdown" href="#" class="dropdown-toggle"> <img
							class="nav-user-photo" src="${pageContext.request.contextPath }/images/avatars/user.jpg"
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Bob Doe's avatar"
																		src="${pageContext.request.contextPath }/images/avatars/user.jpg" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Joe Doe's avatar"
																		src="${pageContext.request.contextPath }/images/avatars/avatar2.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Jim Doe's avatar"
																		src="${pageContext.request.contextPath }/images/avatars/avatar.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Alex Doe's avatar"
																		src="${pageContext.request.contextPath }/images/avatars/avatar5.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Susan's avatar"
																		src="${pageContext.request.contextPath }/images/avatars/avatar3.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Phil Doe's avatar"
																		src="${pageContext.request.contextPath }/images/avatars/avatar4.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Alexa Doe's avatar"
																		src="${pageContext.request.contextPath }/images/avatars/avatar1.png" />
																</div>
