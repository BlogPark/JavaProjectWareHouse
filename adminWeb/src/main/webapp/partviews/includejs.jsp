...
<script type="text/javascript">
	if ('ontouchstart' in document.documentElement)
		document.write("<script src='${pageContext.request.contextPath }/js/jquery.mobile.custom.min.js'>"
						+ "<"+"/script>");
</script>
...
<script src="${pageContext.request.contextPath }/js/jquery.inputlimiter.min.js"></script>
