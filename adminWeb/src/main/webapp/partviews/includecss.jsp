...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/css/bootstrap-switch.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/font-awesome/4.5.0/css/font-awesome.min.css" />
<!-- page specific plugin styles -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/css/jquery-ui.custom.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/css/chosen.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/css/daterangepicker.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/css/bootstrap-datetimepicker.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/css/bootstrap-colorpicker.min.css" />
<!-- text fonts -->
<link rel="stylesheet"
...
<!-- ace styles -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/css/ace.css"	class="ace-main-stylesheet" id="main-ace-style" />
