			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							用户分组管理 <small> <i
								class="ace-icon fa fa-angle-double-right"></i> 设置或修改系统用户分组
									...
									<table id="grouptable"
										...
										<tbody>
											<c:forEach items="${requestScope.grouplist }" var="item">
												<tr id="data${item.ID}" data-gid="${item.ID}">
													...
													<td><fmt:formatDate value="${item.groupAddTime}"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="blue bigger modal-title">添加用户分组</h4>
					</div>
							...
							<form class="form-horizontal" role="form" id="form1" action="${pageContext.request.contextPath }/admin/addgroup"
								...
								<div class="col-xs-11 col-sm-10 col-xs-offset-1 col-sm-offset-2">
									...
									<div class="form-group">
										<label for="form-field-username">分组名称</label>
										<div>
											<input type="text" id="groupName" name="groupName"
												placeholder="分组名称" class="col-xs-11 col-sm-7" />
										</div>
									</div>
									...
									<div class="form-group">
										<label for="form-field-first">分组简介</label>
										<div>
											<input type="text" id="groupAlt" name="groupAlt"
												placeholder="分组简介" class="col-xs-11 col-sm-8" />
										</div>
									</div>
									<div class="space-4"></div>

									<div class="form-group">
										<label for="form-field-first">分组状态</label>
										<div>
